...
var add_image_bovino_1 = require("./add-image-bovino");
var global_1 = require("./../../config/global");
var fs = require("fs");
var path = require("path");
function getImageBovino(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var col, idBovino;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, global_1.loadCollection(add_image_bovino_1.COLLECTION_NAME, add_image_bovino_1.db)];
                case 1:
                    col = _a.sent();
...
exports.getImageBovino = getImageBovino;
//# sourceMappingURL=get-image-bovino.js.map